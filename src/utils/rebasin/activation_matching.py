    ...
    for permutation_name, recording_points in perm_to_hook_description.items():
      ...
      with torch.no_grad():
        for correlation_mode in correlation_modes:
          if correlation_mode == ActivationCorrelationMode.DotProduct:
          ...
          elif correlation_mode in [ActivationCorrelationMode.PearsonCorrelation, ActivationCorrelationMode.PearsonCorrelationWithZeroForConstant]:
            ...
            if correlation_mode == ActivationCorrelationMode.PearsonCorrelationWithZeroForConstant:
