...
class PermutationSpec(NamedTuple):
  perm_to_axes: dict
  axes_to_perm: dict
  activation_matching_modes: Dict[str, Dict[PermutationName, Tuple[LayerName, HookMode]]]
...
def permutation_spec_from_axes_to_perm(axes_to_perm: dict, activation_matching_modes: Dict[str, Dict[PermutationName, Tuple[LayerName, HookMode]]]) -> PermutationSpec:
